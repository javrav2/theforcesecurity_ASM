...
from app.api.routes import auth, users, organizations, assets, vulnerabilities, scans, discovery, nuclei, ports, screenshots, external_discovery, waybackurls, netblocks, labels, scan_schedules, tools, sni_discovery, scan_config, acquisitions, remediation, exceptions, agent, agent_knowledge, graph, github_secrets, mitre, mcp, app_structure, reports, llm_red_team, js_secrets
...
app.include_router(js_secrets.router, prefix=settings.API_PREFIX)
